...
const msgpack = require("./msgpack/msgpack.js");
...
export class NT4_Client {
    ...
    ws_onError(e) {
        console.log("[NT4] Websocket error - ");
        console.log(e);
        this.ws.close();
    }
    ...
    ws_connect() {
        ...
        this.serverAddr = prefix + this.serverBaseAddr + ":" + port.toString() + "/nt/" + "ScratchClient_" + this.clientIdx.toString();
